...
class Library_State extends State<LibraryPage> {
  ...
  pedirColecciones() {
    GetCollections().then((List<String> result) {
      setState(() {
        _collections = result;
      });
    });
            ...
            return AlertDialog(
              ...
              actions: <Widget>[
                ...
                TextButton(
                  ...
                  onPressed: _collectionName.isEmpty
                      ? null
                      : () {
                          //Mostrar libros que puede seleccionar el usuario
                          //Le paso el título de la nueva colección como argumento
                          Navigator.pushNamed(context, 'collectionAdd',
                              arguments: {'collectionName': _collectionName});
                        },
                ),
              ],
            );
